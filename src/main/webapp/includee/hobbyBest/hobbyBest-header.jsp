		...
		<div class="row align-items-center justify-content-center d-flex">
			<nav id="nav-menu-container">
				...
				<ul class="nav-menu" id="maincategory">
					<li class="nav-item"><a href="#" id="white">전체카테고리▼</a>
					...
					<li><a href="<c:url value='/hobby/hobbyMain.do' />" id="white">HOME</a></li>
					<li><a href="<c:url value='/hobby/hobbyBest.do' />" id="white">BEST</a></li>
					<li class="menu-has-children"><a href="<c:url value='/hobby/hobbyPI.do' />" id="white">사전조사</a></li>
				</ul>
				</form>  	
			</nav>
		</div>
